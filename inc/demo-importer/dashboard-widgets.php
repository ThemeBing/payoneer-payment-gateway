...
function paddle_payment_gateway_dashboard_widgets() {
	...
	wp_add_dashboard_widget('paddle_woocommerce_widget', 'Paddle Payment Gateway for WooCommerce', function() {
		echo '<p><a href="https://wordpress.org/plugins/themebing-paddle-payment-gateway-for-woocommerce/" target="_blank">
	...
	wp_add_dashboard_widget('paddle_edd_widget', 'Paddle Payment Gateway for EDD', function() {
		echo '<p><a href="https://wordpress.org/plugins/payment-gateway-paddle-for-easy-digital-downloads/" target="_blank">
		<img style="width: 100%" src="https://ps.w.org/payment-gateway-paddle-for-easy-digital-downloads/assets/banner-772x250.jpg" alt="Paddle Payment Gateway for EDD"></a></p>';
	});
    ...
    // Then we make a backup of your widget.
    $wporg_widget = $wp_meta_boxes['dashboard']['normal']['core']['paddle_edd_widget'];
 
    // We then unset that part of the array.
    unset( $wp_meta_boxes['dashboard']['normal']['core']['paddle_edd_widget'] );
 
    // Now we just add your widget back in.
    $wp_meta_boxes['dashboard']['side']['core']['paddle_edd_widget'] = $wporg_widget;
}
